...
epochs = 1000 #, help='Number of epochs (default: 1000)')
kernel_size = 4 #, help='Size of kernel, i.e. window size. Maximum delay to be found is kernel size - 1. Recommended to be equal to dilation coeffient (default: 4)')
hidden_layers = 0 #, help='Number of hidden layers in the depthwise convolution (default: 0)') 
learning_rate = 0.01 #, help='Learning rate (default: 0.01)')
...
dilation_coefficient = 4 #, help='Dilation coefficient, recommended to be equal to kernel size (default: 4)')
significance = 0.8 #, help="Significance number stating when an increase in loss is significant enough to label a potential cause as true (validated) cause. See paper for more details (default: 0.8)")
...
def my_method(data):
    ...
    allcauses, alldelays, allreallosses, allscores, columns = runTCDF(data)
    #return allcauses, alldelays, allreallosses, allscores, columns
